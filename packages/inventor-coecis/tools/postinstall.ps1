...
# Inventor product key (product identifier - ie. Revit, AutoCAD, 3dsMax, etc...)
# 797N1 = Inventor 2022
$productKey = "797N1"

# Inventor product version
$productVer = "2022.0.0.F"
...
$custExperience = "$env:ProgramFiles\Autodesk\Inventor 2022\AcExperience.arx"
