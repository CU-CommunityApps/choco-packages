...
New-ItemProperty -Path $solid\Security -Name "EULA Accepted 2025 SP02 $env:ComputerName $env:UserName" -Value "Yes" -PropertyType "string" -force
New-ItemProperty -Path $solid\Security -Name "EULA Accepted 2025 SP03 $env:ComputerName $env:UserName" -Value "Yes" -PropertyType "string" -force
...
New-ItemProperty -Path $solid\Security -Name "EULA Accepted 2025 SP3.0 $env:ComputerName $env:UserName" -Value "Yes" -PropertyType "string" -force
...
New-ItemProperty -Path $eDraw -Name "ShowLicense 2025 sp03 $env:ComputerName $env:UserName" -Value "0" -PropertyType "DWORD" -Force
