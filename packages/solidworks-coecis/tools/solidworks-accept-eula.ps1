...
New-ItemProperty -Path $solid\Security -Name "EULA Accepted 2025 SP0.1 $env:ComputerName $env:UserName" -Value "Yes" -PropertyType "string" -force
...
New-ItemProperty -Path $composer -Name "EulaAccepted 2025 7.11.2.24254 $env:ComputerName $env:Username" -Value "1" -PropertyType "DWORD" -Force
# Composer Popups
New-ItemProperty -Path $composer -Name "Composer.EulaAccepted" -Value "0" -PropertyType "DWORD" -Force
New-ItemProperty -Path $composer -Name "Composer.EulaAccepted 2025 2025 7.11.2.24254 $env:ComputerName $env:Username" -Value "1" -PropertyType "DWORD" -Force
...
New-ItemProperty -Path $eDraw -Name "ShowLicense 2025 sp0.1 $env:ComputerName $env:UserName" -Value "0" -PropertyType "DWORD" -Force
