...
# Composer
$3dComposer = "Registry::\HKCU\Software\Dassault Systemes\7.5\Preferences"
If (!(Test-Path $3dComposer)){New-Item -Path $3dComposer -force}
New-ItemProperty -Path $3dComposer -Name "EulaAccepted 2018 SP4.0 $env:ComputerName $env:UserName" -Value "1" -PropertyType "DWORD" -Force
