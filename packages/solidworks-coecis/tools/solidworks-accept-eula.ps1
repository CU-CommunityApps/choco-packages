...
New-ItemProperty -Path $solid\Security -Name "EULA Accepted 2025 SP2.0 BEAC626252BE48A $env:ComputerName $env:UserName" -Value "Yes" -PropertyType "string" -force
...
New-ItemProperty -Path $composer -Name "EulaAccepted 2025 7.12.25318 $env:ComputerName $env:Username" -Value "1" -PropertyType "DWORD" -Force
# Composer Popups
New-ItemProperty -Path $composer -Name "Composer.EulaAccepted" -Value "0" -PropertyType "DWORD" -Force
New-ItemProperty -Path $composer -Name "Composer.EulaAccepted 2025 2025 7.12.25318 $env:ComputerName $env:Username" -Value "1" -PropertyType "DWORD" -Force
...
New-ItemProperty -Path $eDraw -Name "ShowLicense 2025 sp02 9780BEDF9FC7431 $env:ComputerName $env:UserName" -Value "0" -PropertyType "DWORD" -Force
