...
start-process "$env:programFiles\Anaconda\Scripts\conda.exe" -argumentlist "install -y --upgrade pip wheel setuptools" -NoNewWindow
start-sleep -second 60
...
start-sleep -second 60
start-process "$env:programFiles\Anaconda\Scripts\conda.exe" -argumentlist "install -y introcs --upgrade" -NoNewWindow
