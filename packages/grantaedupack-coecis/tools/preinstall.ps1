...
If (!(Test-Path "$env:ALLUSERSPROFILE\Granta Design\CES EduPack 2024")){New-Item "$env:ALLUSERSPROFILE\Granta Design\CES EduPack 2024" -ItemType Directory -Force}
Copy-Item "$env:INSTALL_DIR\license.lic" -Destination "$env:ALLUSERSPROFILE\Granta Design\CES EduPack 2024"
